...
%endif
%ifdef IDE_CONTROLLER_COUNT
	at	ROMVARS.bIdeCnt,		db	IDE_CONTROLLER_COUNT	; Number of supported controllers (Compuadd 450 build: -DIDE_CONTROLLER_COUNT=1, see ../../CHANGES.txt)
%elifdef USE_PS2
